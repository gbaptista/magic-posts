 ...
 */
class Magic_Posts_CakePHP_Inflector {
 ...
 * @var array
 */
  public static $_uninflected = array(
 ...
 * @var array
 */
  public static $_initialState = array();
 ...
 */
  public static function _cache($type, $key, $value = false) {
    $key = '_' . $key;
    $type = '_' . $type;
    if ($value !== false) {
 ...
 *
 * {{{
 * Magic_Posts_CakePHP_Inflector::rules('plural', array('/^(inflect)or$/i' => '\1ables'));
 * Magic_Posts_CakePHP_Inflector::rules('plural', array(
 *     'rules' => array('/^(inflect)ors$/i' => '\1ables'),
 *     'uninflected' => array('dontinflectme'),
 *     'irregular' => array('red' => 'redlings')
 * ));
 * Magic_Posts_CakePHP_Inflector::rules('transliteration', array('/å/' => 'aa'));
 * }}}
 *
 ...
 */
  public static function camelize($lowerCaseAndUnderscoredWord) {
    if (!($result = self::_cache(__FUNCTION__, $lowerCaseAndUnderscoredWord))) {
      $result = str_replace(' ', '', Magic_Posts_CakePHP_Inflector::humanize($lowerCaseAndUnderscoredWord));
 ...
 */
  public static function tableize($className) {
    if (!($result = self::_cache(__FUNCTION__, $className))) {
      $result = Magic_Posts_CakePHP_Inflector::pluralize(Magic_Posts_CakePHP_Inflector::underscore($className));
 ...
 */
  public static function classify($tableName) {
    if (!($result = self::_cache(__FUNCTION__, $tableName))) {
      $result = Magic_Posts_CakePHP_Inflector::camelize(Magic_Posts_CakePHP_Inflector::singularize($tableName));
 ...
 */
  public static function variable($string) {
    if (!($result = self::_cache(__FUNCTION__, $string))) {
      $camelized = Magic_Posts_CakePHP_Inflector::camelize(Magic_Posts_CakePHP_Inflector::underscore($string));
...
Magic_Posts_CakePHP_Inflector::reset();